...
class MenuFormBuilder extends \Library\Form\Builders\FormBuilder {
	...
	public function build() {
		...
		$this->form->add(new \Library\Form\Elements\CheckboxField(array(
			...
			'classes'		=> 'invisible',
			'name'		=> 'private',
			'value'		=> (is_null($this->form->getEntity()->getPrivate()) ? '0' : $this->form->getEntity()->getPrivate())
		)));
		...
		$selectData = array(
				...
				'classes'	=> 'alignment',
				'options'	=> $modules,
				'validators' => array(new \Library\Form\Validators\NotNullValidator('Selectionnez un module pour la page'))
			);
